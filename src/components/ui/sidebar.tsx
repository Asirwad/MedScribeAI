...
import { PanelLeft, Home } from 'lucide-react'; // Added Home import
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background overflow-auto", // Ensure scrolling within inset
